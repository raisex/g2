...
var (
	...
	GxbGenesisHash = common.HexToHash("0x82270b80fc90beb005505a9ef95039639968a0e81b2904ad30128c93d713d2c4")
)
...
var (
	...
	// GxbChainConfig is the chain parameters to run a node on the Gxb main network.
	GxbChainConfig = &ChainConfig{
...
type ChainConfig struct {
	...
	CLOHF1Block *big.Int `json:"clohf1Block,omitempty"` // Gxb Hardfork 1 block
